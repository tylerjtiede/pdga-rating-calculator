...
cli.py
------
Command-line interface for the PDGA rating calculator.

Usage:
    python -m pdga_rater.cli --pdga 12345
    python -m pdga_rater.cli --pdga 12345 --whatif 950,960,970
    python -m pdga_rater.cli --pdga 12345 --target 950 --rounds 3
    python -m pdga_rater.cli --pdga 12345 --refresh
"""
...
def parse_args(argv=None):
    parser = argparse.ArgumentParser(
        description="PDGA rating calculator — project your next rating update.",
...
Examples:
  ...
  %(prog)s --pdga 12345 --refresh
    ...
    parser.add_argument("--rounds",  type=int, default=3,    help="Number of rounds to average for --target (default: 3)")
...
def print_results(result: dict, current_rating: int) -> None:
    ...
    console.print(
        ...
        f"([{change_col}]{change_sign}{change}[/{change_col}] from current {current_rating})"
    )
